...
class ChatMessageCoach extends StatefulWidget {
  String uid,fullname,profile,role;
  ChatMessageCoach({Key? key,required this.uid,required this.profile,required this.fullname,required this.role}) : super(key: key);

  @override
  State<ChatMessageCoach> createState() => _ChatMessageClientState();
}

class _ChatMessageClientState extends State<ChatMessageCoach> {
  ...
  void initState() {
    ...
    wh = widget.role=='sportif'?"Sportifs":"Responsables";
    super.initState();
    init();
  }
  ...
  Future<void> sendMSG(String text) async{
    ...
    firestore.collection("Entraineurs").doc(userId).collection("chats").doc(widget.uid).collection("messages").add(d);

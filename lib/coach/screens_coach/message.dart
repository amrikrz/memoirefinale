...
import 'package:sportapplication/coach/chat_message_coach.dart';
...
class MessageCoachScreen extends StatefulWidget {
  MessageCoachScreen({Key? key}) : super(key: key);

  @override
  State<MessageCoachScreen> createState() => _ChatState();
}

class _ChatState extends State<MessageCoachScreen>{
                                  ...
                                  child: Material(
                                    child: DecoratedBox(
                                      ...
                                      child: Container(
                                        ...
                                        child: ListTile(
                                          onTap: () {
                                            Navigator.of(context).push(CupertinoPageRoute(builder: (context)=>ChatMessageCoach(uid: friendId, profile: profile, fullname: fullName,role: role,)));
                                          },
                                          leading: Container(

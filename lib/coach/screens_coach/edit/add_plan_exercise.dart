...
class AddPlanExercise extends StatefulWidget {
  String planUid;
  AddPlanExercise({Key? key,required this.planUid}) : super(key: key);

  @override
  State<AddPlanExercise> createState() => _AddPlanExercise();
}

class _AddPlanExercise extends State<AddPlanExercise>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Ajouter Plan Exercice",style: TextStyle(color: Colors.pinkAccent,fontWeight: FontWeight.w500),),),
      body: Column(
        ...
        children: [
          ...
          InputModel(c: nom_controller, hint: "Nom de plan d'Exercise", icon: Icons.abc),
          ...
          ElevatedButton(onPressed: () async{
            ...
            await Provider.of<AddPlanExerciceProvider>(context,listen: false).addData(ExerciceObject(name: nom_controller.text, subtitle: desc_controller.text, image: media!.path, uid: "", pereUid: widget.planUid),);

...
class SportifsItemModel extends StatelessWidget {

  ExerciceObject exerciceObject;
  bool coach;
  SportifsItemModel({super.key,required this.exerciceObject,this.coach = true});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ListTile(
            onTap: (){
              Navigator.of(context).push(CupertinoPageRoute(builder: (context)=>ProfileCclient(uid: exerciceObject.uid,)));
            },
            leading: Container(
              width: 70,
              height: 70,

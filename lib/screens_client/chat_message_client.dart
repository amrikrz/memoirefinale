...
class ChatMessageClient extends StatefulWidget {
  ...
  ChatMessageClient({Key? key,required this.uid,required this.profile,required this.fullname,required this.role}) : super(key: key);

  @override
  State<ChatMessageClient> createState() => _ChatMessageClientState();
}
...
class _ChatMessageClientState extends State<ChatMessageClient> {
  ...
  void initState() {
    ...
    wh = widget.role=='coach'?"Entraineurs":"Responsables";
    super.initState();
    init();
  }
  ...
  Future<void> sendMSG(String text) async{
    ...
    firestore.collection("Sportifs").doc(userId).collection("chats").doc(widget.uid).collection("messages").add(d);

...
import 'package:sportapplication/screens_salle/chat_message_salle.dart';




class Message2 extends StatefulWidget {
  Message2({Key? key}) : super(key: key);

  @override
  State<Message2> createState() => _ChatState();
}

class _ChatState extends State<Message2>{
                                  ...
                                  child: Material(
                                    child: DecoratedBox(
                                      ...
                                      child: Container(
                                        ...
                                        child: ListTile(
                                          onTap: () {
                                            Navigator.of(context).push(CupertinoPageRoute(builder: (context)=>ChatMessageSalle(uid: friendId, profile: profile, fullname: fullName,role: role,)));
                                          },
                                          leading: Container(

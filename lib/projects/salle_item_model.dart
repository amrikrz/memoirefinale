...
class SalleItemModel extends StatelessWidget {

  ExerciceObject exerciceObject;
  bool coach;
  SalleItemModel({super.key,required this.exerciceObject,this.coach = true});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ListTile(
            onTap: (){
              Navigator.of(context).push(CupertinoPageRoute(builder: (context)=>ResponsableProfile(/*uid: exerciceObject.uid,*/)));
            },
            leading: Container(
              width: 70,
              height: 70,
